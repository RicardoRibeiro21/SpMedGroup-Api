...
SELECT M.CRM, U.NOME AS MEDICO, C.STATUS_CONSULTA, C.DATA_CONSULTA, C.ID_PRONTUARIO, C.RESULTADO, P.CPF AS CPF_CLIENTE, P.RG AS RG_CLIENTE FROM MEDICOS M JOIN CONSULTAS C ON M.CRM = C.CRM_MEDICO JOIN PRONTUARIOS P ON C.ID_PRONTUARIO = P.ID JOIN USUARIOS U ON U.ID = M.ID_USUARIO  
